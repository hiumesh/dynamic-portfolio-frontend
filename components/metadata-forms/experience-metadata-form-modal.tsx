...
import { getMetadata, updateMetadata } from "@/services/api/experience";
...
export function WorkExperienceMetaDataFormModal({
  isOpen,
  hide,
  onSuccess,
}: PropTypes) {
  ...
  const onSubmit = useCallback(
    async (data: z.infer<typeof workExperienceMetadataFormSchema>) => {
      try {
        setLoading(true);
